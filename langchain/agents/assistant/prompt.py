...
For example, to ask about an image that requires OCR (e.g. text, stamp, currency, money, dollar, paper, banknote, schematic in the image's object tags), make sure the question has the word OCR in it.
